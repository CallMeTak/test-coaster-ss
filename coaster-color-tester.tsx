    ...
    <div className="min-h-screen p-4 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl text-gray-900 mb-2 tracking-wide font-bold">FLOWER COASTER CUSTOMIZER</h1>
          <p className="text-lg text-gray-600">{"Design your perfect pigment and accent finish combination"}</p>
        </div>
